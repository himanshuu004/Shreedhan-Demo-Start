    ...
    <footer className="bg-gray-100 text-gray-800 py-10 mt-20 border-t border-gray-300">
      ...
      <div className="mt-10 text-center text-gray-600 text-sm">
        <div className="flex justify-center space-x-6 mb-4">
          <a href="https://www.facebook.com/share/16AbHHBthi/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="hover:text-green-600">
            <FaFacebook size={22} />
          </a>
          <a href="https://www.instagram.com/khirsu_shreedhan_homestay?utm_source=ig_web_button_share_sheet&igsh=ZDNlZDc0MzIxNw==" target="_blank" rel="noopener noreferrer" className="hover:text-green-600">
            <FaInstagram size={22} />
          </a>
        </div>
